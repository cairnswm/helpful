      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="flex bg-gray-100 rounded-lg p-1" role="group" aria-label="CSS formatting mode">
              <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100vh-320px)]">
          {/* Input Panel */}
          <section className="bg-white rounded-lg shadow-lg border border-gray-200 flex flex-col" aria-labelledby="css-input-heading">
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b rounded-t-lg">
              <h2 id="css-input-heading" className="text-lg font-semibold text-gray-800">CSS Input</h2>
              <button
                onClick={handleClear}
            ...
            <div className="flex-1 p-4">
              <label htmlFor="css-input" className="sr-only">CSS code to {mode === 'format' ? 'format' : 'minify'}</label>
              <textarea
                id="css-input"
                value={input}
