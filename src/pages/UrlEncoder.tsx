    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-[calc(100vh-320px)]">
          {/* Input Panel */}
          <section className="bg-white rounded-lg shadow-lg border border-gray-200 flex flex-col" aria-labelledby="url-input-heading">
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b rounded-t-lg">
              <h2 id="url-input-heading" className="text-lg font-semibold text-gray-800">
            ...
            <div className="flex-1 p-4">
              <label htmlFor="url-encoder-input" className="sr-only">
              ...
              <textarea
                ...
                spellCheck={false}
                aria-label={mode === 'encode' ? 'URL input for encoding' : 'Encoded URL input for decoding'}
              />
            </div>
          </section>

          {/* Output Panel */}
          <section className="bg-white rounded-lg shadow-lg border border-gray-200 flex flex-col" aria-labelledby="url-output-heading">
            <div className="flex items-center justify-between p-4 bg-gray-50 border-b rounded-t-lg">
              <h2 id="url-output-heading" className="text-lg font-semibold text-gray-800">
            ...
            <div className="flex-1 p-4">
              <label htmlFor="url-encoder-output" className="sr-only">
                {mode === 'encode' ? 'URL encoded output' : 'Decoded URL output'}
              </label>
              <textarea
                ...
                aria-label={mode === 'encode' ? 'URL encoded output' : 'Decoded URL output'}
              />
            </div>
          </section>
        </div>
